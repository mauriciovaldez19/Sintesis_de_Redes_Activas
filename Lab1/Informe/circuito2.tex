...
A continuación se muestran los resultados obtenidos en la implementación del circuito:

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile13.png}
	\caption{Implementación $V_{o}=f(V_{in},R_L)$ con $V_{in}= 1$[V], $R_L=1$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile14.png}
	\caption{Implementación $V_{o}=f(V_{in},R_L)$ con $V_{in}= 0.5$[V], $R_L=1$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile15.png}
	\caption{Implementación $V_{o}=f(V_{in},R_L)$ con $V_{in}= 2$[V], $R_L=1$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile16.png}
	\caption{Implementación $V_{o}=f(V_{in},R_L)$ con $V_{in}= 2$[V], $R_L=10$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile17.png}
	\caption{Implementación $V_{o}=f(V_{in},R_L)$ con $V_{in}= 1$[V], $R_L=10$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile18.png}
	\caption{Implementación $V_{o}=f(V_{in},R_L)$ con $V_{in}= 0.5$[V], $R_L=10$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile19.png}
	\caption{Implementación $V_{RL}=f(V_{in},R_L)$ con $V_{in}= 0.5$[V], $R_L=1$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile20.png}
	\caption{Implementación $V_{RL}=f(V_{in},R_L)$ con $V_{in}= 1$[V], $R_L=1$[K$\Omega$]}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{figuras/NewFile21.png}
	\caption{Implementación $V_{RL}=f(V_{in},R_L)$ con $V_{in}= 2$[V], $R_L=1$[K$\Omega$]}
\end{figure}

	A continuación los valores medidos de la tensión de salida respecto a la tensión de entrada y  de un par de valores de $R_L$ propuestos.
...
\begin{table}[H]
 ...
 \multirow{2}{*}{$R_L$[K$\Omega$]} 
			& 1	& 0.486  & 1.16 & 2.28 \\
			& 10	& 7.43  & 8.71 & 8.72  \\ \hline
			
		\end{tabular}
		\caption{Valores medidos de $V_o$ en función de $R_L$ y de $V_{in}$}
	\end{center}
\end{table} 
