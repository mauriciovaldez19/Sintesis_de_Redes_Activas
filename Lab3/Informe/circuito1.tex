...
\hspace{1mm} Con la ayuda de la herramienta Matlab, se graficó el diagrama de Bode de la función de transferencia a lazo abierto del amplificador AO1. En él, es posible observar los polos en $10~Hz$ y en $5.06~MHz$.


\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figuras/7. Opamp_real_lazoabierto.png}
    \caption{Diagrama de Bode del amplificador AO1 lazo abierto}
\end{figure}
